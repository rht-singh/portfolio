        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I am Rohit, a final year student at APIIT SD,India pursuing B.Tech
              in Computer Science.
              <br />
              <br />
              ...
              <i>
                ...
                love doing <b className="purple">Competitive Coding.</b>
              </i>
              <br />I am fluent in classics like
              <i>
                <b className="purple"> Java , Solidity and Javascript </b>
              </i>
              <br />
              <br />
